   ...
   public class DA implements Collection
   {
      ...
      public function join(param1:String) : String
      {
         ...
         if(_size == 1)
         {
            var _temp_1:* = Std;
            null;
            return _temp_1.string(_a[0]);
         }
         var _temp_2:* = Std;
         null;
         var _loc2_:String = _temp_2.string(_a[0]) + param1;
         var _loc3_:int = 1;
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            var _temp_3:* = Std;
            null;
            _loc2_ += _temp_3.string(_a[_loc5_]);
            _loc2_ += param1;
         }
         var _temp_6:* = _loc2_;
         var _temp_5:* = Std;
         null;
         return _temp_6 + _temp_5.string(_a[_size - 1]);
      }
         ...
         if(param3)
         {
            if(param4 != null)
            {
               ...
               while(_loc7_ < _loc9_)
               {
                  ...
                  if(int(param4(_loc5_[_loc8_],param1)) < 0)
                  {
                     _loc7_ = _loc8_ + 1;
                  }
                  else
               ...
               return _loc7_ <= _loc6_ && int(param4(_loc5_[_loc7_],param1)) == 0 ? _loc7_ : ~_loc7_;
            }
            null;
            _loc6_ = _size;
            _loc7_ = param2;
      ...
      public function concat(param1:DA, param2:Boolean = false) : DA
      {
         ...
         if(param2)
         {
            ...
            while(_loc4_ < _loc5_)
            {
               _loc6_ = _loc4_++;
               null;
               var _temp_2:* = _loc3_._a;
               var _temp_1:* = _loc6_;
               null;
               _temp_2[_temp_1] = param1._a[_loc6_ - _size];
               if(_loc6_ >= _loc3_._size)
               {
                  ++_loc3_._size;
               }
         ...
         while(_loc5_ < _loc6_)
         {
            ...
            var _temp_3:* = _loc4_++;
            null;
            _temp_4[_temp_3] = param1._a[_loc7_];
         }
         return this;
      }
      ...
      public function _quickSort(param1:int, param2:int, param3:Function) : void
      {
         ...
         if(param2 > 1)
         {
            ...
            _loc11_ = _a[_loc8_];
            _loc12_ = _a[_loc9_];
            _loc14_ = int(param3(_loc10_,_loc12_));
            if(_loc14_ < 0 && int(param3(_loc10_,_loc11_)) < 0)
            {
               _loc13_ = int(param3(_loc11_,_loc12_)) < 0 ? _loc8_ : _loc9_;
            }
            else if(int(param3(_loc11_,_loc10_)) < 0 && int(param3(_loc11_,_loc12_)) < 0)
            {
               _loc13_ = _loc14_ < 0 ? _loc7_ : _loc9_;
            }
            else
            {
               _loc13_ = int(param3(_loc12_,_loc10_)) < 0 ? _loc8_ : _loc7_;
            }
            _loc15_ = _a[_loc13_];
            _a[_loc13_] = _a[param1];
            while(_loc5_ < _loc6_)
            {
               while(int(param3(_loc15_,_a[_loc6_])) < 0 && _loc5_ < _loc6_)
               {
                  _loc6_--;
               }
               if(_loc6_ != _loc5_)
               ...
               while(int(param3(_loc15_,_a[_loc5_])) > 0 && _loc5_ < _loc6_)
               {
                  _loc5_++;
               }
               if(_loc6_ != _loc5_)
