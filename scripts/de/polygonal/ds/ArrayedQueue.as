package de.polygonal.ds
{
   ...
   public class ArrayedQueue implements Queue
   {
      ...
      public function swp(param1:int, param2:int) : void
      {
         ...
         null;
         var _temp_2:* = _a;
         var _temp_1:* = int((param1 + _front) % _capacity);
         null;
         null;
         _temp_2[_temp_1] = _a[int((param2 + _front) % _capacity)];
         null;
         null;
      ...
      public function shuffle(param1:DA = undefined) : void
      {
         ...
         if(param1 == null)
         {
            ...
            {
               _loc2_--;
               _loc4_ = int((int(Number(_loc3_.random()) * _loc2_) + _front) % _capacity);
               _loc5_ = _a[_loc2_];
               _a[_loc2_] = _a[_loc4_];
               _a[_loc4_] = _loc5_;
            }
         ...
         else
         {
            ...
            while(_loc2_ > 1)
            {
               _loc2_--;
               null;
               _loc6_ = int((int(Number(param1._a[_loc4_++]) * _loc2_) + _front) % _capacity);
               _loc5_ = _a[_loc2_];
               _a[_loc2_] = _a[_loc6_];
               _a[_loc6_] = _loc5_;
            }
         ...
         if(_isResizable && _size < _loc4_)
         {
            if(_sizeLevel > 0 && _capacity > 2)
            {
               ...
               while(_loc7_ < _loc8_)
               {
                  ...
                  _temp_5[_temp_4] = _temp_3[_loc10_];
                  if(_front == _capacity)
                  {
                     _front = 0;
                  }
      ...
      public function enqueue(param1:Object) : void
      {
         ...
         if(_capacity == _size)
         {
            if(_isResizable)
            {
               ...
               while(_loc5_ < _loc6_)
               {
                  ...
                  _temp_4[_temp_3] = _temp_2[_loc8_];
                  if(_front == _capacity)
                  {
                     _front = 0;
                  }
         ...
         _temp_6[int((_loc5_ + _front) % _capacity)] = _loc2_;
      }
         ...
         if(_isResizable && _sizeLevel > 0)
         {
            if(_size == _capacity >> 2)
            {
               ...
               while(_loc2_ < _loc5_)
               {
                  ...
                  _temp_6[_temp_5] = _temp_4[_loc7_];
                  if(_front == _capacity)
                  {
                     _front = 0;
                  }
