package de.polygonal.ds
{
   ...
   public class DLL implements Collection
   {
      ...
      public function DLL(param1:int = 0, param2:int = -1)
      {
         ...
         var _temp_3:* = HashKey;
         var _loc5_:int;
         _temp_3._counter = (_loc5_ = int(_temp_3._counter)) + 1;
         key = _loc5_;
      }
         ...
         while(true)
         {
            ...
            while(_loc4_ != null)
            {
               ...
               while(_loc10_ > 0 || _loc11_ > 0 && _loc5_ != null)
               {
                  ...
                  else if(int(param2(_loc5_.val,_loc4_.val)) >= 0)
                  {
                     _loc6_ = _loc4_;
                     _loc4_ = _loc4_.next;
                     _loc10_--;
      ...
      public function _insertionSort(param1:DLLNode, param2:Function) : DLLNode
      {
         ...
         while(_loc4_ != null)
         {
            ...
            _loc6_ = _loc4_.prev;
            _loc7_ = _loc4_.val;
            if(int(param2(_loc7_,_loc6_.val)) < 0)
            {
               _loc8_ = _loc6_;
               while(_loc8_.prev != null)
               {
                  if(int(param2(_loc7_,_loc8_.prev.val)) >= 0)
                  {
                     break;
                  }
                  _loc8_ = _loc8_.prev;
