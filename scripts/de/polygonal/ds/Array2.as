package de.polygonal.ds
{
   ...
   public class Array2 implements Collection
   {
         ...
         else
         {
            ...
            while(_loc1_ < _loc2_)
            {
               ...
               while(_loc4_ < _loc5_)
               {
                  _loc6_ = _loc4_++;
                  var _temp_4:* = _loc10_;
                  var _temp_3:* = _loc6_ * _h + _loc3_;
                  null;
                  null;
                  _temp_4[_temp_3] = _a[_loc3_ * _w + _loc6_];
               }
            }
            _a = _loc10_;
            _w ^= _h;
      ...
      public function swap(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:int = param4 * _w + param3;
      ...
      public function resize(param1:int, param2:int) : void
      {
         ...
         var _loc3_:Array = _a;
         null;
         var _loc4_:Array = new Array(param1 * param2);
         _a = _loc4_;
