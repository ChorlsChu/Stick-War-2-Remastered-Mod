package de.polygonal.core.fmt
{
   public class NumberFormat
   {
      ...
      public static function toBin(param1:int, param2:String = undefined, param3:Boolean = false) : String
      {
         ...
         _loc5_ = param1;
         var _temp_1:*;
         var _loc4_:int = §§pop() - (_loc5_ < 0 ? 0 : (_loc5_ |= _loc5_ >> 1,_loc5_ |= _loc5_ >> 2,_loc5_ |= _loc5_ >> 4,_loc5_ |= _loc5_ >> 8,_loc5_ |= _loc5_ >> 16,_temp_1 = 32,_loc6_ = _loc5_,_loc6_ -= _loc6_ >> 1 & 0x55555555,_loc6_ = (_loc6_ >> 2 & 0x33333333) + (_loc6_ & 0x33333333),_loc6_ = (_loc6_ >> 4) + _loc6_ & 0x0F0F0F0F,_loc6_ += _loc6_ >> 8,_loc6_ += _loc6_ >> 16,_temp_1 - (_loc6_ & 0x3F)));
