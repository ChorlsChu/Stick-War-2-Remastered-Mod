   ...
   public class AnimatorBase extends EventDispatcher
   {
      ...
      public static function processCurrentFrame(param1:MovieClip, param2:AnimatorBase, param3:Boolean, param4:Boolean = false) : void
      {
         ...
         if(Boolean(param2) && Boolean(param1))
         {
            if(param2.usingCurrentFrame)
            {
               ...
               {
                  _loc6_ = Boolean(param2.motionArray) ? _loc5_ : int(_loc5_ - param2.spanStart);
                  if(!param2.isPlaying)
                  {
      ...
      public function set time(param1:int) : void
      {
         ...
         if(Boolean(this._placeholderName))
         {
            ...
            if(Boolean(_loc6_) && Boolean(_loc6_.parent == this._targetParent) && this._target.parent == this._targetParent)
            {
         ...
         else
         {
            ...
            if(Boolean(_loc3_) && Boolean(!_loc9_) && this._filtersApplied)
            {
