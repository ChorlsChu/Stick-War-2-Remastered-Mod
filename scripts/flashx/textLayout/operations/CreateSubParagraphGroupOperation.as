package flashx.textLayout.operations
{
   ...
   public class CreateSubParagraphGroupOperation extends FlowTextOperation
   {
      ...
      {
         return Boolean(this._spgeParentMarker) ? this._spgeParentMarker.findElement(originalSelectionState.textFlow) as FlowGroupElement : null;
      }
      ...
      public function set parent(value:FlowGroupElement) : void
      {
         ...
         this._spgeParentMarker = Boolean(value) ? new ElementMark(value,0) : null;
      }
