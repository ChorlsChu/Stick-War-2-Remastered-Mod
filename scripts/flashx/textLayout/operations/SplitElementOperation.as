   ...
   public class SplitElementOperation extends FlowTextOperation
   {
      ...
      override public function doOperation() : Boolean
      {
         ...
         if(target != null && !(target is SubParagraphGroupElementBase) && target.getTextFlow() == textFlow)
         {
            ...
            if(Boolean(this._newElement is ListItemElement) && Boolean(this._newElement.listMarkerFormat) && this._newElement.listMarkerFormat.counterReset !== undefined)
            {
            ...
            if(Boolean(textFlow.interactionManager) && Boolean(oldLength != textFlow.textLength) && target is ParagraphElement)
            {
