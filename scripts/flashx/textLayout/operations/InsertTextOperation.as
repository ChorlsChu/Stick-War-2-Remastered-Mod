      ...
      private function doInternal() : void
      {
         ...
         if(span != null)
         {
            if(Boolean(deleteFormat))
            {
               ...
               if(Boolean(deleteFormat is PointFormat && PointFormat(deleteFormat).linkElement && PointFormat(deleteFormat).linkElement.href) && Boolean(originalSelectionState.selectionManagerOperationState) && Boolean(textFlow.interactionManager))
               {
