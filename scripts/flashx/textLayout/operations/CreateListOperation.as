package flashx.textLayout.operations
{
   ...
   public class CreateListOperation extends FlowTextOperation
   {
      ...
      {
         return Boolean(this._listParentMarker) ? this._listParentMarker.findElement(originalSelectionState.textFlow) as FlowGroupElement : null;
      }
      ...
      public function set parent(value:FlowGroupElement) : void
      {
         ...
         if(!value)
         {
            ...
            for(endPos = this.absoluteEnd; true; )
            {
      ...
      override public function doOperation() : Boolean
      {
         ...
         else
         {
            ...
            if(Boolean(testListItem) && testListItem.normalizeNeedsInitialParagraph())
            {
         ...
         if(originalSelectionState.selectionManagerOperationState && Boolean(textFlow.interactionManager))
         {
            textFlow.normalize();
