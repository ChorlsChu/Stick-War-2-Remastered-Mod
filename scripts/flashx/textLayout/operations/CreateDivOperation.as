package flashx.textLayout.operations
{
   ...
   public class CreateDivOperation extends FlowTextOperation
   {
      ...
      {
         return Boolean(this._divParentMarker) ? this._divParentMarker.findElement(originalSelectionState.textFlow) as FlowGroupElement : null;
      }
         ...
         else
         {
            ...
            else
            {
               while(begChildIndex < endChildIndex)
               {
                  ...
                  {
                     while(Boolean(child.numChildren))
                     {
