package flashx.textLayout.edit
{
   ...
   internal class IMEClient implements IIMEClient
   {
      ...
      private function rollBackIMEChanges() : void
      {
         ...
         if(Boolean(this._imeLength > 0 && previousIMEOperation) && Boolean(previousIMEOperation.endGeneration == this._editManager.textFlow.generation) && previousIMEOperation.canUndo())
         {
      ...
      {
         if(Boolean(this._controller && this._controller.container) && Boolean(this._controller.container.stage) && this._controller.container.stage.focus != this._controller.container)
         {
            this._controller.setFocus();
         }
      }
