package flashx.textLayout.edit
{
   ...
   public class ElementRange
   {
      ...
      public function get containerFormat() : ITextLayoutFormat
      {
         ...
         return Boolean(container) ? container.computedFormat : this._textFlow.computedFormat;
      }
      ...
      public function getCommonCharacterFormat() : TextLayoutFormat
      {
         ...
         for(var attr:TextLayoutFormat = new TextLayoutFormat(leaf.computedFormat); true; )
         {
