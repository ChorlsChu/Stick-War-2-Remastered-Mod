package flashx.textLayout.compose
{
   ...
   public class ParcelList
   {
      ...
      {
         var newParcel:Parcel = this._numParcels == 0 && Boolean(this._singleParcel) ? this._singleParcel.initialize(this._verticalText,column.x,column.y,column.width,column.height,controller,columnIndex) : new Parcel(this._verticalText,column.x,column.y,column.width,column.height,controller,columnIndex);
