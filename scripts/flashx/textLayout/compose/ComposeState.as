package flashx.textLayout.compose
{
   ...
   public class ComposeState extends BaseCompose
   {
      ...
      override protected function doVerticalAlignment(canVerticalAlign:Boolean, nextParcel:Parcel) : void
      {
         ...
         if(Boolean(canVerticalAlign && _curParcel) && Boolean(this.vjBeginLineIndex != this._curLineIndex) && !this.vjDisableThisParcel)
         {
      ...
      override protected function composeNextLine() : TextLine
      {
         ...
         var useExistingLine:Boolean = Boolean(line) && (!line.isDamaged() || line.validity == FlowDamageType.GEOMETRY);
