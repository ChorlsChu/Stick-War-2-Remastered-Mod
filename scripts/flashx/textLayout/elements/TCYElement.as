package flashx.textLayout.elements
{
   ...
   public final class TCYElement extends SubParagraphGroupElementBase
   {
      ...
      override tlf_internal function mergeToPreviousIfPossible() : Boolean
      {
         ...
         if(Boolean(parent) && !bindableElement)
         {
      ...
      private function updateTCYRotation() : void
      {
         ...
         {
            groupElement.textRotation = Boolean(contElement) && contElement.computedFormat.blockProgression == BlockProgression.RL ? TextRotation.ROTATE_270 : TextRotation.ROTATE_0;
         }
      }
   }
}
