package com.brockw.stickwar.engine.maps
{
   ...
   public class Forest extends Map
   {
      ...
      public function Forest(game:StickWar)
      {
         super();
         this.init(game);
      }
      ...
      override public function init(game:StickWar) : void
      {
         ...
         vector.push(new forestForeground());
         vector.push(new forestMiddleground());
         vector.push(new forestBackground());
         vector.push(new forestSky());
