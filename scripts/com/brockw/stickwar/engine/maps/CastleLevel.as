package com.brockw.stickwar.engine.maps
{
   ...
   public class CastleLevel extends Map
   {
      ...
      public function CastleLevel(game:StickWar)
      {
         super();
         this.init(game);
      }
      ...
      override public function init(game:StickWar) : void
      {
         ...
         vector.push(new castleLevelForeground());
         vector.push(new castleLevelMiddleground());
         vector.push(new castleLevelBackground());
