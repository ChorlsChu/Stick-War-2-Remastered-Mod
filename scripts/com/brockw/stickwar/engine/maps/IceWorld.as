package com.brockw.stickwar.engine.maps
{
   ...
   public class IceWorld extends Map
   {
      ...
      public function IceWorld(game:StickWar)
      {
         super();
         this.init(game);
      }
      ...
      override public function init(game:StickWar) : void
      {
         ...
         vector.push(new iceHillsForeground());
         vector.push(new iceHillsMountains());
         vector.push(new iceHillsMiddleground());
         vector.push(new iceHillsBackgroundSky());
