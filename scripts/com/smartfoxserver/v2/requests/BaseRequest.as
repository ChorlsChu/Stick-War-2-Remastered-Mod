package com.smartfoxserver.v2.requests
{
   ...
   public class BaseRequest implements IRequest
   {
      ...
      public function getMessage() : IMessage
      {
         ...
         message.id = this._id;
         message.isEncrypted = this._isEncrypted;
         message.targetController = this._targetController;
         message.content = this._sfso;
